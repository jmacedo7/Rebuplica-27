...
export class AuthService {
  ...
  readonly #jwt:{secret:string;issuer:string;audience:string};
  constructor(users:UserRepository,jwt:{secret:string;issuer:string;audience:string}){this.#users=users;this.#jwt=jwt;}
